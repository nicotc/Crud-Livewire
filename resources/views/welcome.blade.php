...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">CRUD-Livewire</a>
                            ...
                            <table class="table table-striped table-sm">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Url</th>
                                        <th scope="col" style="width: 180px">Acción</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Chocolateros</td>
                                        <td>Marketplace de venta de chocolates</td>
                                        <td>Chocolateros.net</td>
                                        <td>
